...
public class Fin extends JFrame {
    ...
    public Fin() {
        ...
        texte += "&#9Je ne serai jamais assez reconnaissant de ce que vous avez fait pour tous les habitants du royaume. ";
        texte += "Une statue sera &eacute;rig&eacute;e &agrave; la capitale en guise de remerciement et de votre courage. ";
