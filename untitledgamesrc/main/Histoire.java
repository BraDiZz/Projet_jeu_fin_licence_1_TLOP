...
public class Histoire extends JFrame {
    ...
    public Histoire() {
        ...
        texte += "<br/>";
        texte += "<h3>Bonjour aventurier, le royaume est accul&eacute; par nos ennemis de toujours : <b>Les Darkins !</b></h3><br/>";
        texte += "<h3>Je demande donc votre aide pour nous aider &agrave; les vaincre et sauver le royaume. ";
