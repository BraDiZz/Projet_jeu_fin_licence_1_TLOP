    ...
    */
    ...
    class NextTurn implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Game.this.setTitle(worldName + " : Tour de " + hero[heroTurn].getNom());
            updateStats();
        }
    }
    /**
    ...
    /**
     * Class pour mettre a jour les statistiques du joueurs
     */
    ...
    public void init() {
	    ...
	    setTitle(worldName + " : Tour de " + hero[heroTurn].getNom());
        setResizable(true);
